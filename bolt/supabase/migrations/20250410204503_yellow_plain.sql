/*
  # Fix Authentication Setup with Provider ID
  ...
  2. Security
    ...
    - Sets up correct identity provider information
    - Updates RLS policies to use correct JWT claims
*/
...
-- Create test user with proper password hashing and metadata
...
-- Update identities for the user with required provider_id
INSERT INTO auth.identities (
  ...
  '123e4567-e89b-12d3-a456-426614174001',
  '123e4567-e89b-12d3-a456-426614174001',
  jsonb_build_object('sub', '123e4567-e89b-12d3-a456-426614174001', 'email', 'test@school.com'),
  'email',
  'test@school.com',
  now(),
  now(),
...
-- Fix RLS policies to use correct metadata path
