/*
  # Fix stored procedures and policies
  
  1. Changes
    - Update stored procedures to use auth.users instead of users table
    - Fix policies to use correct table references
    - Add proper schema references
    
  2. Security
    - Maintain same security model
    - Use correct table access
*/
